...
export const awards: Award[] = [
  ...
  },
  {
    ...
    description: "2nd Place award at Hackathon 2026 with theme \"Innovating Beyond The Code\" for building Safe Route — a real-time safety navigation mobile app that routes users away from crime hotspots and sends instant SOS via WhatsApp & Telegram. Built by Team MATA: Malika, Aisyah, Tohari, and Ali.",
    link: "https://github.com/icecoffie/safe-route",
    date: "2026",
    issuer: "HIM|IE — Hackathon Committee",
